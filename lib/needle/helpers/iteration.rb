  ...
  class Iteration
    ...
    def run
      ...
      thor.insert_into_file("testcases/#{testcase}/iteration.spec", :before => "#END_ITERATION\n") do
        "#{name}|10|ALL IMMEDIATELY|SESSIONS 10|ALL IMMEDIATELY|hpd_tours|127.0.0.1 192.168.255.2 -|1|ALL 1|ALL 1 0 2000|ALL ALL 1|ALL ALL 3 10 50|ALL 1|ALL 0 0 0 0|default|10000\n"
      end
